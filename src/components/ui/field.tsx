...
function FieldLegend({
  ...
  return (
    <legend
      ...
      className={cn(
        "mb-3 font-medium data-[variant=label]:font-label data-[variant=label]:text-sm data-[variant=legend]:text-base",
        className
      )}
      {...props}
    />
...
function FieldTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="field-label"
      className={cn(
        "flex w-fit items-center gap-2 font-label text-sm font-medium group-data-[disabled=true]/field:opacity-50",
        className
      )}
      {...props}
    />
